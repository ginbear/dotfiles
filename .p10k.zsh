# Generated by Powerlevel10k configuration wizard on 2025-07-11 at 18:17 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_CLASSES=(
      ...
      '*'         OTHER)
  typeset -g POWERLEVEL9K_TERRAFORM_PROD_FOREGROUND=255 # 白い文字
  typeset -g POWERLEVEL9K_TERRAFORM_PROD_BACKGROUND=208 # 深いオレンジ (K8sのprdと同じ色で統一感を持たせる)
  typeset -g POWERLEVEL9K_TERRAFORM_OTHER_FOREGROUND=250 # ライトグレー
  typeset -g POWERLEVEL9K_TERRAFORM_OTHER_BACKGROUND=238 # ダークグレー (K8sのdefaultと同じ色で統一感を持たせる)
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=255 # ライトグレー (見やすい)
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_BACKGROUND=208 # ダークグレー (背景に馴染む)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=250 # ライトグレー (見やすい)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=238 # ダークグレー (背景に馴染む)
